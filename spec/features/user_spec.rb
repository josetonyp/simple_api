...
describe "Users Api", type: :request do
  ...
  it "creates a valid user account" do
    expect{
      post "/api/users", {user: user_attributes}.to_json
  ...
  it "validates presence of user's full_name" do
    post "/api/users", {user: {full_name: ""}}.to_json
  ...
  it "validates presence of user's email" do
    post "/api/users", {user: {full_name: "Some Person"}}.to_json
  ...
  it "validates presence of user's password" do
    post "/api/users", {user: {email: "test@test.com", password: "", full_name: "Some Person"}}.to_json
  ...
  it "validates uniqness of user's email" do
    ...
    post "/api/users", {user: {email: user.email}}.to_json
